...
public class MasterSearcherNoui {

    private Zeroconf zeroconf;
    private ArrayList<DiscoveredService> discoveredMasters;
    private DiscoveryAdapterNoui discoveryAdapter;
    ...
    public MasterSearcherNoui(Context context, final ListView listView,
        ...
        discoveryHandler = new DiscoveryHandlerNoui(discoveryAdapter, discoveredMasters);
